...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-10 col-sm-offset-2">
            <h1>{{ trans('coreadmin::qa.menus-createCrud-create_new_crud') }}</h1>
    ...
    <div class="form-group">
        {!! Form::label('parent_id', trans('coreadmin::qa.menus-createCrud-crud_parent'), ['class'=>'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
    ...
    <div class="form-group">
        {!! Form::label('name', trans('coreadmin::qa.menus-createCrud-crud_name'), ['class'=>'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
            {!! Form::text('name', old('name'), ['class'=>'form-control', 'placeholder'=> trans('coreadmin::qa.menus-createCrud-crud_name_placeholder')]) !!}
        </div>
    </div>

    <div class="form-group">
        {!! Form::label('title', trans('coreadmin::qa.menus-createCrud-crud_title'), ['class'=>'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
            {!! Form::text('title', old('title'), ['class'=>'form-control', 'placeholder'=> trans('coreadmin::qa.menus-createCrud-crud_title_placeholder')]) !!}
        </div>
    </div>

    <div class="form-group">
        {!! Form::label('roles', trans('coreadmin::qa.menus-createCrud-roles'), ['class'=>'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
    ...
    <div class="form-group">
        {!! Form::label('soft', trans('coreadmin::qa.menus-createCrud-soft_delete'), ['class'=>'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
            {!! Form::select('soft', [1 => trans('coreadmin::strings.yes'), 0 => trans('coreadmin::strings.no')], old('soft'), ['class' => 'form-control']) !!}
        </div>
    </div>

    <div class="form-group">
        {!! Form::label('icon', trans('coreadmin::qa.menus-createCrud-icon'), ['class'=>'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
            {!! Form::text('icon', old('icon','fa-database'), ['class'=>'form-control', 'placeholder'=> trans('coreadmin::qa.menus-createCrud-icon_placeholder')]) !!}
        </div>
    </div>

    <hr/>

    <h3>{{ trans('coreadmin::qa.menus-createCrud-add_fields') }}</h3>

    <table class="table">
        <tbody id="generator">
            <tr>
                <td>{{ trans('coreadmin::qa.menus-createCrud-show_in_list') }}</td>
                <td></td>
                <td></td>
                <td></td>
                <td></td>
    ...
    <div class="form-group">
        <div class="col-md-12">
            <button type="button" id="addField" class="btn btn-success"><i
                        class="fa fa-plus"></i> {{ trans('coreadmin::qa.menus-createCrud-add_field') }}
            </button>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-md-12">
            {!! Form::submit(trans('coreadmin::qa.menus-createCrud-create_crud'), ['class' => 'btn btn-primary']) !!}
        </div>
    </div>
    ...
    <div style="display: none;">
        ...
        @foreach($models as $key => $model)
            <select name="f_relationship_field[{{ $key }}]" class="form-control relationship-field rf-{{ $key }}">
                <option value="">{{ trans('coreadmin::qa.menus-createCrud-select_display_field') }}</option>
