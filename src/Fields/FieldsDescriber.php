<?php
namespace CoreSolutions\CoreAdmin\Fields;
...
class FieldsDescriber
{
    ...
    {
        return [
            'optional'        => trans('coreadmin::strings.optional'),
            'required'        => trans('coreadmin::strings.required'),
            'required|unique' => trans('coreadmin::strings.required_unique')
        ];
    }
    ...
    {
        return [
            'false' => trans('coreadmin::strings.default_unchecked'),
            'true'  => trans('coreadmin::strings.default_checked'),
        ];
    }
}